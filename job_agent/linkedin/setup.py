...
def prompt_for_cookie() -> str:
    ...
    cookie = "AQEDAVQXeIoBiuYKAAABmnLK-JEAAAGaltd8kU4AeCP3hjNME5_bQc0RDYMOvFs12F033j6mYqQIumdeZcI_o-ePosa-N6zZNJgVkoGR1Ebr_m8_LLJhP71i7i4jtF88UpLOQLVJYJf3d1rmIAtwdyYX"
    print(f"here is the cookie: {cookie}")
    if not cookie:
